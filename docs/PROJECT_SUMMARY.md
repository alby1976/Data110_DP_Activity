...
The latest full suite reports **461 passed, 2 expected failures** for unfinished
stages. The sensitivity runner is implemented; study-specific scenarios still need CLI configuration. Export, charts, the full pipeline smoke test, and Power BI
